...
%   T_hill    = 4.772  (results/exp11_hc/tucker_seed0/loss_log.json)
%   S         = 4.758  (results/exp11/swiglu_seed0/loss_log.json)
%
%   delta_hill_swiglu = T_hill - S = +0.014  (~1.5% perplexity gap)
%   delta_hill_default = T_default - T_hill = +0.344  (~30% perplexity reduction
%                                                       from the hill-climb)
%
